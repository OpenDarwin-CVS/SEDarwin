 ...
 */
	...
	syss(nosys,0),		/* 368 */
	syss(nosys,0),		/* 369 */
	syss(nosys,0),		/* 370 = Future expansion by Apple */
	syss(nosys,0),		/* 371 = Future expansion by Apple */
	syss(nosys,0),		/* 372 = Future expansion by Apple */
	syss(nosys,0),		/* 373 = Future expansion by Apple */
	syss(nosys,0),		/* 374 = Future expansion by Apple */
	syss(nosys,0),		/* 375 = Future expansion by Apple */
	syss(nosys,0),		/* 376 = Future expansion by Apple */
	syss(nosys,0),		/* 377 = Future expansion by Apple */
	syss(nosys,0),		/* 378 = Future expansion by Apple */
	syss(nosys,0),		/* 379 = Future expansion by Apple */
	syss(extattrctl,5),		/* 380 = extattrctl */
	syss(extattr_set_file,5),	/* 381 = extattr_set_file */
	syss(extattr_get_file,5),	/* 382 = extattr_get_file */
	syss(extattr_delete_file,3),	/* 383 = extattr_delete_file */
	syss(extattr_list_file,4),	/* 384 = extattr_list_file */
	syss(extattr_set_fd,5),		/* 385 = extattr_set_fd */
	syss(extattr_get_fd,5),		/* 386 = extattr_get_fd */
	syss(extattr_delete_fd,3),	/* 387 = extattr_delete_fd */
	syss(extattr_list_fd,4),	/* 388 = extattr_list_fd */
	syss(extattr_set_link,5),	/* 389 = extattr_set_link */
	syss(extattr_get_link,5),	/* 390 = extattr_get_link */
	syss(extattr_delete_link,3),	/* 391 = extattr_delete_link */
	syss(extattr_list_link,4),	/* 392 = extattr_list_link */
	syss(__mac_execve,4),	/* 393 = __mac_execve */
	syss(__mac_syscall,3),	/* 394 = __mac_syscall */
	syss(__mac_get_file,2),	/* 395 = __mac_get_file */
	syss(__mac_set_file,2),	/* 396 = __mac_set_file */
	syss(__mac_get_link,2), /* 397 = __mac_get_link */
	syss(__mac_set_link,2),	/* 398 = __mac_set_link */
	syss(__mac_get_proc,1),	/* 399 = __mac_get_proc */
	syss(__mac_set_proc,1),	/* 400 = __mac_set_proc */
	syss(__mac_get_fd,2),	/* 401 = __mac_get_fd */
	syss(__mac_set_fd,2),	/* 402 = __mac_set_fd */
	syss(__mac_get_pid,2),	/* 403 = __mac_get_pid */
