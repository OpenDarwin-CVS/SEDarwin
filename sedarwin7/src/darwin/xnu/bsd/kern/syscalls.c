...
char *syscallnames[] = {
	...
	"#368",			/* 368 */
	"#369",			/* 369 */
	"#370",			/* 370 = Future expansion by Apple */
	"#371",			/* 371 = Future expansion by Apple */
	"#372",			/* 372 = Future expansion by Apple */
	"#373",			/* 373 = Future expansion by Apple */
	"#374",			/* 374 = Future expansion by Apple */
	"#375",			/* 375 = Future expansion by Apple */
	"#376",			/* 376 = Future expansion by Apple */
	"#377",			/* 377 = Future expansion by Apple */
	"#378",			/* 378 = Future expansion by Apple */
	"#379",			/* 379 = Future expansion by Apple */
	"extattrctl",		/* 380 = extattrctl */
	"extattr_set_file",	/* 381 = extattr_set_file */
	"extattr_get_file",	/* 382 = extattr_get_file */
	"extattr_delete_file",	/* 383 = extattr_delete_file */
	"extattr_list_file",	/* 384 = extattr_list_file */
	"extattr_set_fd",	/* 385 = extattr_set_fd */
	"extattr_get_fd",	/* 386 = extattr_get_fd */
	"extattr_delete_fd",	/* 387 = extattr_delete_fd */
	"extattr_list_fd",	/* 388 = extattr_list_fd */
	"extattr_set_link",	/* 389 = extattr_set_link */
	"extattr_get_link",	/* 390 = extattr_get_link */
	"extattr_delete_link",	/* 391 = extattr_delete_link */
	"extattr_list_link",	/* 392 = extattr_list_link */
	"__mac_execve",		/* 393 = __mac_execve */
	"__mac_syscall",	/* 394 = __mac_syscall */
	"__mac_get_file",	/* 395 = __mac_get_file */
	"__mac_set_file",	/* 396 = __mac_set_file */
	"__mac_get_link",	/* 397 = __mac_get_link */
	"__mac_set_link",	/* 398 = __mac_set_link */
	"__mac_get_proc",	/* 399 = __mac_get_proc */
	"__mac_set_proc",	/* 400 = __mac_set_proc */
	"__mac_get_fd",		/* 401 = __mac_get_fd */
