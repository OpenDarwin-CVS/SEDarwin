...
au_event_t sys_au_event[] = {
	...
	AUE_NULL,			/* 368 */
	AUE_NULL,			/* 369 */
	AUE_NULL,			/* 370 = Future expansion by Apple */
	AUE_NULL,			/* 371 = Future expansion by Apple */
	AUE_NULL,			/* 372 = Future expansion by Apple */
	AUE_NULL,			/* 373 = Future expansion by Apple */
	AUE_NULL,			/* 374 = Future expansion by Apple */
	AUE_NULL,			/* 375 = Future expansion by Apple */
	AUE_NULL,			/* 376 = Future expansion by Apple */
	AUE_NULL,			/* 377 = Future expansion by Apple */
	AUE_NULL,			/* 378 = Future expansion by Apple */
	AUE_NULL,			/* 379 = Future expansion by Apple */
	AUE_NULL,			/* 380 = extattrctl */
	AUE_EXTATTR_SET_FILE,	       	/* 381 = extattr_set_file */
	AUE_EXTATTR_GET_FILE,	       	/* 382 = extattr_get_file */
	AUE_EXTATTR_DELETE_FILE,       	/* 383 = extattr_delete_file */
	AUE_EXTATTR_LIST_FILE,         	/* 384 = extattr_list_file */
	AUE_EXTATTR_SET_FD,		/* 385 = extattr_set_fd */
	AUE_EXTATTR_GET_FD,		/* 386 = extattr_get_fd */
	AUE_EXTATTR_DELETE_FD,		/* 387 = extattr_delete_fd */
	AUE_EXTATTR_LIST_FD,		/* 388 = extattr_list_fd */
	AUE_EXTATTR_SET_LINK,	       	/* 389 = extattr_set_link */
	AUE_EXTATTR_GET_LINK,  		/* 390 = extattr_get_link */
	AUE_EXTATTR_DELETE_LINK,       	/* 391 = extattr_delete_link */
	AUE_EXTATTR_LIST_LINK,	       	/* 392 = extattr_list_link */
	AUE_MAC_EXECVE,			/* 393 = __mac_execve */
	AUE_MAC_SYSCALL,       		/* 394 = __mac_syscall */
	AUE_MAC_GET_FILE,	       	/* 395 = __mac_get_file */
	AUE_MAC_SET_FILE,	       	/* 396 = __mac_set_file */
	AUE_MAC_GET_LINK,	       	/* 397 = __mac_get_link */
	AUE_MAC_SET_LINK,	       	/* 398 = __mac_set_link */
	AUE_NULL,			/* 399 = __mac_get_proc */
	AUE_MAC_SET_PROC,      		/* 400 = __mac_set_proc */
	AUE_MAC_GET_FD,			/* 401 = __mac_get_fd */
	AUE_MAC_SET_FD,			/* 402 = __mac_set_fd */
	AUE_MAC_GET_PID,		/* 403 = __mac_get_pid */
	/*
