...
static int    *boot_exdata = 0;
static size_t  boot_exdatalen = 0;

int preload_find_data (const char *name, size_t *size, void **ptr)
{
  size_t  rlen = boot_exdatalen;
  int    *exp = boot_exdata;
 ...
 */
	...
	boot_exdata = args->exdata;
	boot_exdatalen = args->exdatalen;
