/*
 * NAI: This file was modified to allow it to compile without
 * requiring IOKit - the KXKextManagerError enumeration is included
 * directly in these sources, instead of referencing an external copy.
 */
