...
#define CAPABILITY__DAC_EXECUTE                   0x00000002UL
#define CAPABILITY__DAC_WRITE                     0x00000004UL
#define CAPABILITY__DAC_READ_SEARCH               0x00000008UL
#define CAPABILITY__FOWNER                        0x00000010UL
#define CAPABILITY__FSETID                        0x00000020UL
#define CAPABILITY__KILL                          0x00000040UL
#define CAPABILITY__SETFCAP                       0x00000080UL
#define CAPABILITY__SETGID                        0x00000100UL
#define CAPABILITY__SETUID                        0x00000200UL
#define CAPABILITY__AUDIT_CONTROL                 0x00000400UL
#define CAPABILITY__AUDIT_WRITE                   0x00000800UL
#define CAPABILITY__LINUX_IMMUTABLE               0x00001000UL
#define CAPABILITY__NET_BIND_SERVICE              0x00002000UL
#define CAPABILITY__NET_BROADCAST                 0x00004000UL
#define CAPABILITY__NET_ADMIN                     0x00008000UL
#define CAPABILITY__NET_RAW                       0x00010000UL
#define CAPABILITY__IPC_LOCK                      0x00020000UL
#define CAPABILITY__IPC_OWNER                     0x00040000UL
#define CAPABILITY__SYS_MODULE                    0x00080000UL
#define CAPABILITY__SYS_RAWIO                     0x00100000UL
#define CAPABILITY__SYS_CHROOT                    0x00200000UL
#define CAPABILITY__SYS_PTRACE                    0x00400000UL
#define CAPABILITY__SYS_PACCT                     0x00800000UL
#define CAPABILITY__SYS_ADMIN                     0x01000000UL
#define CAPABILITY__SYS_BOOT                      0x02000000UL
#define CAPABILITY__SYS_NICE                      0x04000000UL
#define CAPABILITY__SYS_RESOURCE                  0x08000000UL
#define CAPABILITY__SYS_TIME                      0x10000000UL
#define CAPABILITY__SYS_TTY_CONFIG                0x20000000UL
#define CAPABILITY__MKNOD                         0x40000000UL
