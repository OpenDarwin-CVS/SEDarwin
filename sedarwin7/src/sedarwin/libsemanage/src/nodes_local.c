...
int semanage_node_modify_local(
...
int semanage_node_exists_local(
	semanage_handle_t* handle,
	const semanage_node_key_t* key,
	int* response) {
...
int semanage_node_iterate_local(
	semanage_handle_t* handle,
	int (*handler) (
