...
extern int semanage_node_query(
	semanage_handle_t* handle,
	const semanage_node_key_t* key,
	semanage_node_t** response);

extern int semanage_node_exists(
	semanage_handle_t* handle,
	const semanage_node_key_t* key,
	int* response);

extern int semanage_node_count(
	semanage_handle_t* handle,
	unsigned int* response);

extern int semanage_node_iterate(
	semanage_handle_t* handle,
	int (*handler) (
