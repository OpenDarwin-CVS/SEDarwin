...
static struct av_perm_to_string av_perm_to_string[] = {
   ...
   { SECCLASS_DBUS, DBUS__ACQUIRE_SVC, "acquire_svc" },
   { SECCLASS_DBUS, DBUS__SEND_MSG, "send_msg" },
   { SECCLASS_NSCD, NSCD__GETPWD, "getpwd" },
   { SECCLASS_NSCD, NSCD__GETGRP, "getgrp" },
   { SECCLASS_NSCD, NSCD__GETHOST, "gethost" },
   { SECCLASS_NSCD, NSCD__GETSTAT, "getstat" },
   { SECCLASS_NSCD, NSCD__ADMIN, "admin" },
};
